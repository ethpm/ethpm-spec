...
release.
  ...
  :Key: ``contract_types``
  :Type: Object (String: `contract-type-object-v2`_)
  :Format:
      Keys **must** be valid |ContractAliases|.

      Values **must** conform to the `contract-type-object-v2`_ definition.
...
The set of chains defined by the :ref:`BIP122 URI<bip122-v2>` keys for this
object **must** be unique. There cannot be two different URI keys in a deployments
field representing the same blockchain.

  :Key: ``deployments``
  :Type: Object (String: Object(String: `contract-instance-object-v2`_))
  :Format: See Below.
...
Values **must** be objects which conform to the following format.
    ...
    -  Values **must** be a valid `contract-instance-object-v2`_.
...
bytecode which require |linking|.
  ...
  :Required: No
  :Type: Array
  :Format: All values **must** be valid :ref:`Link Reference objects <link-reference-object-v2>`.
    See also below.
...
to link the corresponding bytecode.
  ...
  :Required: No
  :Type: Array
  :Format: All values **must** be valid :ref:`Link Value objects <link-value-object-v2>`.
    See also below.
...
-  Each :ref:`link value object <link-value-object-v2>` **must** have a
   corresponding :ref:`link reference object <link-reference-object-v2>` under
...
``runtime_bytecode``.
  ...
  :Required: No
  :Type: Object
  :Format: **must** conform to the `compiler-information-object-v2`_
   format.

----

.. _compiler-information-object-v2:
